# Generated by Django 4.0.2 on 2022-03-27 12:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('Student', 'Student'), ('Teacher', 'Teacher'), ('SchoolAdmin', 'SchoolAdmin')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='management.subject', verbose_name='subject')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule_class_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='management.scheduleclasses', verbose_name='Schedule Class')),
                ('student_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='student')),
            ],
            options={
                'db_table': 'Attendence',
            },
